                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($vdata) && isset($vdata['tracking'])) : ?>
                                                        ...
                                                        <?php elseif ($vdata['tracking'] == 'Pengumpulan Revisi Ujian Proposal') : ?>
                                                        ...
                                                        <?php elseif ($vdata['tracking'] == 'Pengumpulan Revisi Seminar Hasil') : ?>
                                                            <div class="badge badge-dark-blue6"><?= $vdata['tracking'] ?></div>
                                                        <?php elseif ($vdata['tracking'] == 'Ajuan Bimbingan Sidang') : ?>
