                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="dt_mastermahasiswa">
                            ...
                            <?php foreach ($data as $vdata): ?>
                                <tr>
                                    ...
                                    <td><?= $vdata['prodi'] ?></td>
                                    <td><?= $vdata['no_telp'] ?></td>
                                    <td><?= $vdata['th_masuk'] ?></td>
                                    <td><?= $vdata['th_lulus'] ?></td>
                                    <td><?= $vdata['kelas'] ?></td>
                                    <td class="text-end">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            <a href="<?= base_url('mastermahasiswa/edit/'.$vdata['id_mhs']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Data">
                                            ...
                                            <form action="<?= base_url('mastermahasiswa/delete/'.$vdata['id_mhs']) ?>" method="post">
