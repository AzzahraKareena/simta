                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Data Users</span>
                            <span class="text-muted mt-1 fw-bold fs-7">List data users tersedia</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="dt_timeline">
                                ...
                                <tbody>
                                    <?php foreach ($data as $vdata): ?>
                                        <tr>
                                            <td>
                                                <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= $vdata['email'] ?></span>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="<?= base_url('users/edit/'.$vdata['id']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Data">
                                                    ...
                                                    <form action="<?= base_url('users/delete/'.$vdata['id']) ?>">
