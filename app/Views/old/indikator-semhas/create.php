                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-bold fs-7">Isi data indikator semhas dengan benar</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body py-3">
                        <!--begin::Form-->
                        <form class="form w-100" method="post" enctype="multipart/form-data" id="form_indikator" action="<?= service('router')->getMatchedRoute()[0] == "indikator_semhas/create" ? base_url('indikator_semhas/store') : base_url('indikator_semhas/update/'.($dataForm['id_indikator'] ?? "")) ?>">
                            <?= csrf_field() ?>
                            <!--begin::Input group-->
