            ...
            <div class="col">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body py-3">
                        <!--begin::Form-->
                        <form class="form w-100" method="post" id="form_syaratkelulusan" action="<?= service('router')->getMatchedRoute()[0] == "syaratkelulusan/create" ? base_url('syaratkelulusan/store') : base_url('syaratkelulusan/update/'.$dataForm->id_syarat_kelulusan??"") ?>" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            ...
                            <div class="col-12 col-md-6">
                                    ...
                                    <input type="hidden" name="status_pengajuan" value="Sedang Diproses">
                                </div>
                            </div>  
