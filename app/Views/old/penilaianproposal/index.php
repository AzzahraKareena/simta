                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Data Penilaian Ujian Proposal</span>
                            <span class="text-muted mt-1 fw-bold fs-7">List penilaian ujian proposal</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                                        ...
                                        <tr>
                                            ...
                                            <?php if(session()->get('role') == 'Dosen'): ?>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <!-- <a href="<?= base_url('penilaianproposal/edit/'.$item['id_penilaian']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Data">
                                                    ...
                                                    <a href="<?= base_url('penilaianproposal/pdf/'.$item['id_penilaian']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="_blank" title="Cetak Penilaian Sempro">
                                                            <span class="svg-icon svg-icon-3">
