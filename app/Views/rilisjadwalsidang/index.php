                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Data Jadwal Sidang TA</span>
                            <span class="text-muted mt-1 fw-bold fs-7">List data jadwal Sidang TA</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    ...
                                                    <?php if(session()->get('role') == 'Dosen'): ?>
                                                        <a href="<?= base_url('penilaiansidang/create/' . $item['id_rilis_jadwal_sidang']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Penilian Sidang Akhir">
                                                            <span class="svg-icon svg-icon-muted svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
