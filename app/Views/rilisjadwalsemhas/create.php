        ...
        <div class="col">
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body py-3">
                    ...
                    <form class="form w-100" method="post" enctype="multipart/form-data" id="form_rilis_jadwal" action="/rilisjadwalsemhas/store">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-12 col-md-12">

                                <input type="hidden" name="id_pengajuansemhas" id="id_pengajuansemhas" value="<?= $pengajuan['id_seminarhasil']; ?>">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <input type="text" class="form-control form-control-lg form-control-solid" value="<?= $nama_dosen_penguji1 ?>" disabled />
                                    <input type="hidden" name="id_penguji1" value="<?= $id_dosen_penguji1 ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="text-end">
