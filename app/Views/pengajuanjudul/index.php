                        ...
                        <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex align-items-center position-relative my-1 mt-3">
                                    <label for="year-select" class="form-label me-3">Select Year:</label>
                                    <select id="year-select" class="form-select form-select-solid w-150px">
                                        <!-- Options will be generated by JavaScript -->
                                    </select>
                                </div>
                                <!--end::Select Year-->
                                <!--begin::Script to Generate Year Options-->
                                <script>
                                    window.onload = function() {
                                        ...
                                        select.value = currentYear; // Set the default selected year to the current year
                                    }

                                    document.getElementById('year-select').addEventListener('change', function() {
                                        var selectedYear = this.value;
                                        // Implement the filter functionality based on the selected year
