            ...
            <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9" width="100%">
                ...
                <thead class="border-gray-200 fs-5 fw-bold bg-lighten">
                    <tr>
                        ...
                        <th width="22%" class="min-w-150px">Dospem</th>
                    ...
                    <?php foreach ($pengajuan as $item) : ?>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center text-center">
                                ...
                                <a href="#" class="btn btn-icon btn-light-danger btn-active-color-light btn-sm">
...
<?php foreach ($pengajuan as $item) : ?>
<div class="modal fade" id="detailPengajuanJudul" tabindex="-1" aria-hidden="true">
                                ...
                                <tbody>
                                    <?php foreach ($pengajuan as $item) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bolder text-dark fs-6"><?= $item['nama_judul1'] ?></span>
                                                <span class="text-dark fs-6"><?= $item['deskripsi_sistem1'] ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="fs-6 fw-bolder">Judul 2</th>
                                            <td>
                                                <span class="fw-bolder text-dark fs-6"><?= $item['nama_judul2'] ?></span>
                                                <span class="text-dark fs-6"><?= $item['deskripsi_sistem2'] ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="fs-6 fw-bolder">Judul 3</th>
                                            <td>
                                                <span class="fw-bolder text-dark fs-6"><?= $item['nama_judul3'] ?></span>
                                                <span class="text-dark fs-6"><?= $item['deskripsi_sistem3'] ?></span>
                                            </td>
                                        </tr>
                                        <tr>
