                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Data Pengajuan Judul</span>
                    ...
                    <div class="card-body py-3">
                        <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <!--end::Script to Generate Year Options-->
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="dt_pengajuanjudul">
                                ...
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        <th class="">Nama Judul 1</th>
                                        <th class="">Deskripsi Sistem 1</th>
                                        <th class="">Nama Judul 2</th>
                                        <th class="">Deskripsi Sistem 2</th>
                                ...
                                <?php if (!empty($pengajuan) && is_array($pengajuan)) : ?>
                                    <?php foreach ($pengajuan as $item) : ?>
                                        <tr>
                                            ...
                                            <td><?= $item['deskripsi_sistem1'] ?></td>
                                            <td><?= esc($item['nama_judul2']) ?></td>
                                            <td><?= $item['deskripsi_sistem2'] ?></td>
                                            <td><?= esc($item['nama_judul3']) ?></td>
                                            <td><?= $item['deskripsi_sistem3'] ?></td>
