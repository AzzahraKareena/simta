                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Data Kriteria</span>
                            <span class="text-muted mt-1 fw-bold fs-7">List data kriteria tersedia</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                        ...
                        <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                                    <!--begin::Add customer-->
                                    <a href="<?= base_url('kriteria/create')?>" class="btn btn-primary" data-bs-toggle="tooltip" title="Klik tambah data">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="<?= base_url('kriteria/edit/'.$vdata['id_kriteria']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Data">
                                                    ...
                                                    <form action="<?= base_url('kriteria/delete/'.$vdata['id_kriteria']) ?>" method="POST">
