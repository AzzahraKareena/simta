                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Data Jadwal Ujian Proposal</span>
                            <span class="text-muted mt-1 fw-bold fs-7">List data jadwal ujian proposal</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="<?= base_url('rilisjadwal/berita-acara/'. $item['id_rilis_jadwal']) ?>" target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Unduh Berita Acara">
                                                    ...
                                                    <?php if(session()->get('role') == 'Dosen'): ?>
                                                        <a href="<?= base_url('penilaianproposal/create/' . $item['id_rilis_jadwal']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Penilaian Proposal">
                                                            <span class="svg-icon svg-icon-muted svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
