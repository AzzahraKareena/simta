            ...
            <div class="col">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body py-3">
                        ...
                        <form class="form w-100" method="post" enctype="multipart/form-data" id="form_rilis_jadwal" action="<?= service('router')->getMatchedRoute()[0] == "rilisjadwal/create" ? base_url('rilisjadwal/store') : base_url('rilisjadwal/update/'.$dataForm['id_rilis_jadwal']??"") ?>">
                            <?= csrf_field() ?>
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <?php if(service('router')->getMatchedRoute()[0] == "rilisjadwal/create") : ?>
                                        ...
                                        <input type="hidden" name="id_pengajuanujianpropo" id="id_pengajuanujianpropo" value="">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                var dataMahasiswa = <?= json_encode(array_reduce($pengajuan, function($result, $pengaju) {
                    $result[$pengaju['nim']] = [
                        ...
                        'judul' => $pengaju['judul'],
                        'id_pengajuanujianpropo' => $pengaju['id_ujianproposal']
                    ];
                    return $result;
                }, [])); ?>;
                ...
                document.getElementById('nim').addEventListener('change', function() {
                    ...
                    var IdUjianInput = document.getElementById('id_pengajuanujianpropo');
                    
                    if (dataMahasiswa[nim]) {
                        namaInput.value = dataMahasiswa[nim].nama;
                        judulInput.value = dataMahasiswa[nim].judul;
                        IdUjianInput.value = dataMahasiswa[nim].id_pengajuanujianpropo;
                    } else {
                        namaInput.value = '';
                        judulInput.value = '';
                        IdUjianInput.value = '';
