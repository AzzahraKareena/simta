                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="dt_masterstaf">
                                ...
                                <?php foreach ($data as $vdata): ?>
                                    <tr>
                                        ...
                                        <td><?= $vdata['nip_staf'] ?></td>
                                        <td><?= $vdata['no_telpon'] ?></td>
                                        <td><?= $vdata['alamat_staf'] ?></td>
                                        <td><?= $vdata['jenis_staf'] ?></td>
                                        <td>
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            <a href="<?= base_url('masterstaf/edit/'.$vdata['id_masterstaf']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Data">
                                            ...
                                            <form action="<?= base_url('masterstaf/delete/'.$vdata['id_masterstaf']) ?>" method="post">
