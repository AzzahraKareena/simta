                                ...
                                <?php foreach ($data as $vdata): ?>
                                    <tr>
                                        ...
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            <a href="<?= base_url('masterstaf/edit/'.$vdata['id_staf']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Data">
                                            ...
                                            <form action="<?= base_url('masterstaf/delete/'.$vdata['id_staf']) ?>" method="post">
