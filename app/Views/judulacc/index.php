    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                ...
                <div class="my-1 me-4">
                    <!--begin::Select-->
                    <form action="/judulacc" method="get" class="d-flex align-items-center position-relative my-1 mt-3" id="myForm" role="form">
                ...
                <!--begin::Add subscription-->
                    <!-- <a href="<?= base_url('judulacc/create') ?>" class="btn btn-sm btn-primary my-4">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9" width="100%">
                    ...
                    <thead class="border-gray-200 fs-5 fw-bold bg-lighten">
                        <tr>
                            <th width="20%" class="min-w-175px">Nama</th>
                            <th width="20%" class="min-w-150px ps-5">Judul Acc</th>
                            <th width="20%" class="min-w-150px ps-5">Dospem</th>
                            <th width="20%" class="min-w-150px ps-5">Keterangan</th>
                            <?php if(session()->get('role') == 'Koordinator' || session()->get('nama') == 'Masbahah '): ?>
                            <th width="20%" class="min-w-150px ps-5"></th>
                            <?php endif; ?>
                        </tr>
                    </thead>
                    <!--end::Thead-->
                    ...
                    <tbody class="fw-6 fw-bold text-gray-600">
                        <?php foreach ($data as $vdata) : ?>
                            <tr>
                                <td>
                                    <span class="fw-bolder d-block fs-6"><?= ucwords($vdata['mahasiswa_nama']) ?></span>
                                    <!-- <span class="text-dark fw-bold text-hover-primary mb-1 fs-6"><?= $vdata['mahasiswa_nama'] ?></span> -->
                                </td>
                                <td class="ps-5"><?= $vdata['judul_acc'] ?></td>
                                <td class="ps-5"><?= $vdata['dospem_nama'] ?></td>
                                <td class="ps-5"><?= $vdata['keterangan'] ?? '-' ?></td>
                                <?php if(session()->get('role') == 'Koordinator' || session()->get('nama') == 'Masbahah '): ?>
                                <td class="align-middle ps-5">
                                    <div class="d-flex justify-content-center">
                                        <!-- <a href="#" class="btn btn-icon btn-light-info btn-active-color-light btn-sm me-1" data-bs-toggle="modal" data-bs-target="#detailPengajuanJudul">
    ...
    <?php else : ?>
        <div class="card-body pb-0">
            ...
            <div class="card-px text-center pt-20 pb-5">
                <!--begin::Title-->
                <h2 class="fs-2x fw-bolder mb-0">Judul yang Diterima</h2>
                <!--end::Title-->
                <!--begin::Description-->
                <p class="text-gray-400 fs-4 fw-bold py-7">Belum ada data
                <br />Judul yang Diterima.</p>
            </div>
            <!--end::Heading-->
            <!--begin::Illustration-->
