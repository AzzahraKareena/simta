            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Form Penilaian Seminar Hasil</span>
                        <span class="text-muted mt-1 fw-bold fs-7">Isi data penilaian seminar hasil dengan benar</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body py-3">
                    <!--begin::Form-->
                    <form class="form w-100" method="post" enctype="multipart/form-data" id="form_pengajuanjudul" action="<?= base_url('penilaiansemhas/store') ?>">
                        <?= csrf_field() ?>
                        <!--begin::Input group-->
                        ...
                        <?php foreach ($mahasiswa as $mhs) : ?>
                            ...
                            <input type="hidden" class="form-control form-control-lg form-control-solid" name="id_rilis_jadwal_semhas" value="<?= $mhs['id_rilis_jadwal_semhas'] ?>">
                        ...
                        <table width="100%" cellpadding="5" border="1">
                            ...
                            <tbody>
                                ...
                                foreach ($indikator as $id_kriteria => $data) : ?>
                                    ...
                                    <td><input type="number" class="form-control form-control-lg form-control-solid" name="nilai[<?= $indi['id_indikator'] ?>]" id="nilai" max="<?= $indi['max_nilai'] ?>" required></td>
                                    </tr>
                                <?php
                                            $first = false;
                                        endforeach;
