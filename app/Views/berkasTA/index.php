                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">File Berkas Tugas Akhir</span>
                    ...
                    <div class="card-body py-3">
                        <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                                    <!--begin::Add customer-->
                                    <a href="<?= base_url('berkasTA/create')?>" class="btn btn-primary" data-bs-toggle="tooltip" title="Klik tambah file">
                        ...
                        <div class="table-responsive">
                            <!--begin::Table-->
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="dt_berkasTA">
                                <!--begin::Table head-->
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        <th class="">Nama Berkas</th>
                                        <th class="">File Berkas</th>
                                ...
                                <tbody>
                                    <?php foreach ($data as $vdata): ?>
                                        <tr>
                                            <td>
                                                <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= $vdata['nama_berkas'] ?></span>
                                                <span class="text-muted fw-bold text-muted d-block fs-7">Nama Berkas: <?=$vdata['nama_berkas']?></span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= $vdata['file_berkas'] ?></span>
                                                <span class="text-muted fw-bold text-muted d-block fs-7">File Berkas: <?=$vdata['file_berkas']?></span>
                                            </td>
