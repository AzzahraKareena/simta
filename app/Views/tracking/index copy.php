                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="d-flex flex-stack mb-5">
                            ...
                            <div>
                                <select id="tracking_filter" class="selectFilter form-select text-capitalize ms-3">
                                ...
                                <tbody>
                                    <?php if (!empty($data) && is_array($data)) : ?>
                                        <?php foreach ($data as $vdata): ?>
                                            <tr>
                                                <td>
                                                    <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= htmlspecialchars($vdata['mahasiswa_nama'], ENT_QUOTES, 'UTF-8') ?></span>
                                                </td>
                                                <td>
                                                    <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= htmlspecialchars($vdata['angkatan'], ENT_QUOTES, 'UTF-8') ?></span>
                                                </td>
                                                <td>
                                                    <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= htmlspecialchars($vdata['judul_acc'], ENT_QUOTES, 'UTF-8') ?></span>
                                                </td>
                                                <td>
                                                    <?php if (!empty($vdata) && isset($vdata['tracking'])) : ?>
                                                        <?php
                                                            $badgeClasses = [
                                                                'Pengajuan Judul' => 'badge-warning',
                                                                'Judul Acc' => 'badge-dark-blue12',
                                                                'Pengajuan Bimbingan Ujian Proposal' => 'badge-dark-blue11',
                                                                'Pengajuan Ujian Proposal' => 'badge-dark-blue10',
                                                                'Pengumpulan Revisi Ujian Proposal' => 'badge-dark-blue9',
                                                                'Pengajuan Bimbingan Seminar Hasil' => 'badge-dark-blue8',
                                                                'Pengajuan Seminar Hasil' => 'badge-dark-blue7',
                                                                'Pengumpulan Revisi Seminar Hasil' => 'badge-dark-blue6',
                                                                'Ajuan Bimbingan Sidang' => 'badge-dark-blue5',
                                                                'Pengajuan Sidang' => 'badge-dark-blue4',
                                                                'Revisi Sidang' => 'badge-dark-blue3',
                                                                'Unggah Syarat Kelulusan' => 'badge-dark-blue1',
                                                            ];
                                                            $badgeClass = $badgeClasses[$vdata['tracking']] ?? 'badge-default';
                                                        ?>
                                                        <div class="badge <?= $badgeClass ?>"><?= htmlspecialchars($vdata['tracking'], ENT_QUOTES, 'UTF-8') ?></div>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <span class="text-dark fw-bolder text-hover-primary d-block fs-6"><?= htmlspecialchars($vdata['dospem_nama'], ENT_QUOTES, 'UTF-8') ?></span>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
