                    ...
                    <div class="card-body py-3">
                        <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <form action="/rekapitulasi-nilai" method="get" class="d-flex align-items-center position-relative my-1 mt-3" id="myForm" role="form">
                                ...
                                <tbody>
                                    <?php foreach ($data as $item) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('rekapitulasi-nilai/cetak/' . $item['mahasiswa']['id_user']) ?>" target="_blank" class="btn btn-icon btn-light-primary btn-active-color-light btn-sm me-1" data-bs-toggle="tooltip" title="Cetak Nilai Akhir">
