                                ...
                                <tbody>
                                    <?php foreach ($data as $item) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('rekapitulasi-nilai/cetak/' . $item['mahasiswa']['id_user']) ?>" target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Cetak Nilai Akhir">
