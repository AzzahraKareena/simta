                                        ...
                                        <tr>
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-dark">
                                                                    <li>
                                                                        <a class="dropdown-item" href="#">
                                                                            <form class="alert-verifikasi" action="/update/status_up/semhas/<?= $vdata['id_seminarhasil']; ?>" method="POST">
                                                                                <?= csrf_field() ?>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <?php if (empty($vdata['jadwal_id']) && session()->get('role') == 'Dosen'): ?>
                                                        <a href="<?= base_url('pengajuanseminarhasil/create-jadwal/'. $vdata['id_seminarhasil']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Buat Rilis Jadwal">
                                                    ...
                                                    <?php if(session()->get('role') == 'Mahasiswa' && $vdata['status_pengajuan'] == 'REVISI'): ?>
                                                        <button onclick="openFileUploaderLaporan(<?php echo $vdata['id_seminarhasil']; ?>)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Upload Revisi">
                                                            <span class="svg-icon svg-icon-muted svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <!-- Icon untuk unduh berkas -->
                                                        <a href="<?= base_url('pengajuanseminarhasil/unduh-revisi/'. $vdata['id_seminarhasil']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Unduh Revisi">
                                                            <span class="svg-icon svg-icon-muted svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.3" d="M10 4H21C21.6 4 22 4.4 22 5V7H10V4Z" fill="currentColor"/>
                                                    ...
                                                    <?php endif; ?>
                                                    <a href="<?= base_url('pengajuanseminarhasil/rekomendasi/'. $vdata['id_seminarhasil']) ?>" target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Unduh Surat Rekomendasi">
                                                        <span class="svg-icon svg-icon-muted svg-icon-3"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
