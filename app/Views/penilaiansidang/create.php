            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Form Penilaian Sidang Akhir</span>
                        <span class="text-muted mt-1 fw-bold fs-7">Isi data penilaian sidang akhir dengan benar</span>
                    </h3>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body py-3">
                    <!--begin::Form-->
                    <form class="form w-100" method="post" enctype="multipart/form-data" id="form_pengajuanjudul" action="<?= base_url('penilaiansidang/store') ?>">
                        <?= csrf_field() ?>
                        <!--begin::Input group-->
                        ...
                        <?php foreach ($mahasiswa as $mhs) : ?>
                            ...
                            <input type="hidden" class="form-control form-control-lg form-control-solid" name="id_rilis_jadwal_sidang" value="<?= $mhs['id_rilis_jadwal_sidang'] ?>">
