                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Data Penilaian Sidang Akhir</span>
                            <span class="text-muted mt-1 fw-bold fs-7">List penilaian Sidang Akhir</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body py-3">
                        <!--begin::Wrapper-->
                            <div class="d-flex flex-stack mb-5">
                                ...
                                <!--end::Search-->
                                <form action="/penilaiansidang" method="get" class="d-flex align-items-center position-relative my-1 mt-3" id="myForm" role="form">
                                        ...
                                        <tr>
                                            ...
                                            <?php if(session()->get('role') == 'Dosen'): ?>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <form action="<?= base_url('penilaiansidang/delete/'.$item['id_penilaian']) ?>" method="POST">
                                                    ...
                                                    <a href="<?= base_url('penilaiansidang/pdf/'.$item['id_penilaian']) ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="_blank" title="Cetak Penilaian Semhas">
                                                            <span class="svg-icon svg-icon-3">
