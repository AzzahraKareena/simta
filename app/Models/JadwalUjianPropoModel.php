...
class JadwalUjianPropoModel extends Model
{
    ...
    {
        return $this->select('mahasiswa.nama as nama_mhs, mahasiswa.nim as nim, u1.nama as penguji1, u2.nama as penguji2, simta_acc_judul.judul_acc as judul, simta_rilis_jadwal.*')
