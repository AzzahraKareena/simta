...
class PenilaianProposalDetailModel extends Model
{
    ...
    protected $allowedFields = ['id_penilaian_detail', 'id_indikator', 'nilai', 'id_penilaian_pro'];
    ...
    {
        return $this->join('simta_penilaian_ujianproposal as pnl', 'pnl.id_penilaian = simta_penilaian_ujianproposal_detail.id_penilaian_pro')
