...
class JadwalSemhasModel extends Model
{
    ...
    {
        return $this->select('mahasiswa.nama as nama_mhs, mahasiswa.nim as nim,  mahasiswa.prodi as prodi, u3.id as id_mhs, u1.nama as penguji1, u2.nama as penguji2, simta_acc_judul.judul_acc as judul, simta_rilis_jadwal_semhas.*')
    ...
    {
        return $this->select('mahasiswa.nama as nama_mhs, mahasiswa.nim as nim,  mahasiswa.prodi as prodi, u3.id as id_mhs, u1.nama as penguji1, u2.nama as penguji2, s1.nip as nip_penguji1, s2.nip as nip_penguji2, simta_acc_judul.judul_acc as judul, dosen.nama, simta_pengajuan_seminarhasil.*, simta_rilis_jadwal_semhas.*')
            ->join('users as u1', 'simta_rilis_jadwal_semhas.id_penguji1=u1.id')
            ->join('users as u2', 'simta_rilis_jadwal_semhas.id_penguji2=u2.id')
            ->join('simta_pengajuan_seminarhasil', 'simta_rilis_jadwal_semhas.id_pengajuansemhas=simta_pengajuan_seminarhasil.id_seminarhasil')
            ->join('users as u3', 'simta_pengajuan_seminarhasil.id_mhs=u3.id')
